		...
		<div class="x-list-item-meta activity-meta">
			<div class="x-list-item-meta-inner">
				...
				<?php if ( bp_get_activity_type() == 'activity_comment' ) : ?>
					...
					<a href="<?php bp_activity_thread_permalink(); ?>" class="view bp-secondary-action" title="<?php esc_attr_e( 'View Conversation', 'buddypress' ); ?>"><?php _e( 'View Conversation', 'buddypress' ); ?></a>
				...
				<?php if ( is_user_logged_in() ) : ?>
					...
					<?php if ( bp_activity_can_comment() ) : ?>
						...
						<a href="<?php bp_activity_comment_link(); ?>" class="acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Comment <span class="x-bp-count">%s</span>', 'buddypress' ), bp_activity_get_comment_count() ); ?></a>
