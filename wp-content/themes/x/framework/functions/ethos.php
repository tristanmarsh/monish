  ...
  function x_ethos_entry_top_navigation() {
    ...
    ?>
      ...
      <div class="entry-top-navigation">
        <a href="<?php echo $link; ?>" class="entry-parent" title="<?php $title; ?>"><i class="x-icon-th" data-icon="&#xf00a;"></i></a>
        ...
        <div class="x-comment-content-wrap">
          <header class="x-comment-header">
            <div class="x-comment-meta">
              ...
              <?php endif; ?>
              <?php edit_comment_link( __( 'Edit <i class="x-icon-edit" data-icon="&#xf044;"></i>', '__x__' ) ); ?>
            </div>
            <?php
