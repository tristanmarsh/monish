      ...
      <div class="changelog">
        <div class="feature-section three-col">
          <div class="col">
            ...
            <p>The <a href="https://theme.co/community/kb/" target="_blank">Knowledge Base</a> is where we include all of our in-depth documentation for the theme, including dozens of high definition videos.</p>
          ...
          <div class="col">
            ...
            <p>X is so much more than a theme. It's also a collection of resources from some of the world's top <a href="https://theme.co/community/experts/" target="_blank">Internet marketers</a>.</p>
            <p>While we've built many of the items discussed by these experts directly into the theme, we're also able to bring you <a href="https://theme.co/community/training/" target="_blank">incredible training</a> to help take your website to the next level.</p>
          </div>
          <div class="col">
            <h3><span class="dashicons dashicons-tickets"></span> WordPress Tutorials</h3>
            <p>New to WordPress? Don't worry, we've all been there. If you're still working your way through the foundational elements of WordPress, you will be pleased to know that we have <a href="https://theme.co/community/kb/" target="_blank">dozens of high definition videos</a> available for free in the member center to help you with many of the most commonly asked questions that new users have.</p>
          </div>
          <div class="col">
            <h3><span class="dashicons dashicons-admin-page"></span> Child Themes</h3>
            <p>If you're planning on doing any amount of customization outside of the settings afforded in the Customizer, <a href="https://theme.co/community/child-themes/" target="_blank">child themes</a> are absolutely the way to go.</p>
      ...
      <div class="changelog">
        <div class="feature-section three-col">
          ...
          <div class="col">
            ...
            <p>Once you have registered for access to the member center, go generate your <a href="https://theme.co/community/my-account/" target="_blank">product API key</a> under the "Licenses" section. This key is used for automatic updates (<a href="https://theme.co/community/kb/product-validation/" target="_blank">tutorial here</a>).</p>
          </div>
          <div class="col">
