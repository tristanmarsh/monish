    ...
    <div class="x-container max width">
      <header class="entry-header">
        ...
        <h1 class="entry-title">
          <a href="<?php echo esc_url( $link ); ?>" title="<?php echo esc_attr( sprintf( __( 'Shared link from post: "%s"', '__x__' ), the_title_attribute( 'echo=0' ) ) ); ?>" target="_blank" class="entry-external-link"><i class="x-icon-paperclip" data-icon="&#xf0c6;"></i></a>
          <?php echo $link; ?>
        </h1>
        <?php else : ?>
