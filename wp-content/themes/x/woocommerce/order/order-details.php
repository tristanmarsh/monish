...
<?php endif; ?>
    ...
    <address>
      <?php
        if ( ! $order->get_formatted_billing_address() ) _e( 'N/A', '__x__' ); else echo $order->get_formatted_billing_address();
      ?>
    </address>
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
  ...
  <div class="col-2">
    ...
    <address>
      <?php
        if ( ! $order->get_formatted_shipping_address() ) _e( 'N/A', '__x__' ); else echo $order->get_formatted_shipping_address();
      ?>
    </address>
